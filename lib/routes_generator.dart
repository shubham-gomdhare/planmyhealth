    ...
    switch (settings.name) {
      case '/':
        return MaterialPageRoute(
            settings: RouteSettings(name: '/'), builder: (_) => Welcome());
      case '/signup':
        return MaterialPageRoute(
          builder: (context) => SignUp.create(
            context,
          ),
        );
      case '/phone':
...
//                ));
      ...
      // case '/doctors':
      //   return MaterialPageRoute(builder: (_) => DoctorsList(null));
      // case '/doctorProfil':
      //   return MaterialPageRoute(builder: (_) => DoctorAcount());
      // case '/firstDoctorBook':
      //   return MaterialPageRoute(builder: (_) => DoctorBookFirstStep(null));
