...
class DoctorBookFirstStep extends StatelessWidget {
  final DoctorBloc bloc;
  final Doctor doctor;
  final User user;
  DoctorBookFirstStep(this.bloc, this.doctor, this.user);
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ball('images/doctor-3.jpg', Colors.transparent),
                          Column(
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            DoctorBookSecondeStep(bloc, doctor, user),
                      ),
                    );
                  },
      ...
      choices.add(Container(
        ...
        child: StreamBuilder<String>(
            ...
            builder: (context, snapshot) {
              return ChoiceChip(
                label: Text(item),
                selected: snapshot.hasData ? snapshot.data == item : false,
                onSelected: (selected) {
                  bloc.selectTime(item);
                },
              );
            }),
      ));
